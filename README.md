...
## About
Kocom Wallpad with RS485 for 힐스테이트영통

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/hogamm/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
